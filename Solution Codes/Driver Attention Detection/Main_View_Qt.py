...
class MainUi(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        self.scrollBar_horizon      = self.findChild(QSlider, name='sliderBar_Threshold_Horizon') 
    ...
    def update(self):
        ...
        self.label_horizonThreshold.setText('horizontal threshold:     ' + str(hThreshold) )
        self.label_verticalThreshold.setText('vertical threshold：     ' + str(vThreshold) )
        ...
        rotation_str = 'current head direction： ' + str(head_rotation_str)
